...
```
Error: Can't reach database server at `rm-shuyao-dev-pub.mysql.rds.aliyuncs.com:3306`
Please make sure your database server is running at `rm-shuyao-dev-pub.mysql.rds.aliyuncs.com:3306`.
```
...
| 阻断项 | 状态 |
|---|---|
| 无法建立到 `rm-shuyao-dev-pub.mysql.rds.aliyuncs.com:3306` 的 TCP 连接 | 已确认 |
...
1. **恢复 VPN / 网络 / DB allowlist**，使当前机器能够到达 `rm-shuyao-dev-pub.mysql.rds.aliyuncs.com:3306`
