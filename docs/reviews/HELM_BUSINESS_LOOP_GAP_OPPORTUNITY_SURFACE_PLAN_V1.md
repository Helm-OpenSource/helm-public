...
---
# HELM_BUSINESS_LOOP_GAP_OPPORTUNITY_SURFACE_PLAN_V1
...
1. 让 `opportunities` 复用共享 `businessLoopGapSummary`
2. 保持 `BusinessFirstSurfaceSummary` 四类信息 contract 不变

## 3. 范围

### In Scope

- `features/opportunities/page-loader.ts`
...
- `opportunities` 首屏复用共享 `businessLoopGapSummary.primaryGap`
- `opportunities` 继续只显示 `对象状态 / 阻塞 / 待决策 / 下一步动作`
