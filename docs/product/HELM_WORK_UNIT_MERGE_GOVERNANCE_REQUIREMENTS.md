...
tenant / overlay 侧真实 activation receipt 持久化与执行、经验资产真实持久化 / 自动应用和 proof viewer 仍属于后续切片。
Public Core 仍只保存 schema、guard、测试、synthetic fixture、只读运行时读出、只读 append plan、
owner lifecycle plan、activation handoff plan、repair learning plan 和 demo 复核面。
