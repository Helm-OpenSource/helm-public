...
但只承接 Apache-2.0 public Core、基础 SDK、sample pack、公开测试、
Docker quickstart 与公开治理文档。
...
公开文档面必须刻意保持小而可审计。私有源仓库里的规划、review、商业、
...
- [交付工程师 Golden Path 要求 / Delivery engineer Golden Path requirements](product/HELM_DELIVERY_ENGINEER_GOLDEN_PATH_REQUIREMENTS.md)
...
- [Extension 目录与命名协议 / Extension directory and naming protocol](product/HELM_MULTI_TENANT_EXTENSION_DIRECTORY_AND_NAMING_PROTOCOL_V1.md)
- [Operating signal flow map 要求 / Operating signal flow map requirements](product/HELM_OPERATING_SIGNAL_FLOW_MAP_REQUIREMENTS.md)
...
- [公开试点 runbook / Public trial runbook](pilot/PUBLIC_TRIAL_RUNBOOK.md)
- [公开试点数据政策 / Public trial data policy](legal/HELM_PUBLIC_TRIAL_DATA_POLICY_V1.md)
- [试点响应与 on-call 姿态 / Trial response and on-call posture](operations/ON_CALL_AND_RESPONSE_SLA.md)
- [公开 release train runbook / Public release train runbook](operations/HELM_PUBLIC_RELEASE_TRAIN_RUNBOOK.md)
...
- [OPC 周报 packet 模板 / OPC weekly packet template](operations/HELM_OPC_WEEKLY_PACKET_TEMPLATE.md)
- [中国访问性与证据路由 packet / China accessibility and evidence routing packet](operations/HELM_CHINA_ACCESSIBILITY_AND_EVIDENCE_ROUTING_2026-06-02.md)
...
- secret remediation 回执与私有部署证据 / Secret remediation receipts and private deployment evidence
