...
发布版本号：`v0.1.0-trial` · License：Apache-2.0 · 仓库：github.com/Helm-Developers/helm2026
...
Release: `v0.1.0-trial` · License: Apache-2.0 · Repository: github.com/Helm-Developers/helm2026
...
> 今天发布 Helm v0.1.0-trial：受控试点的经营推进控制台。Apache-2.0 开源 + 阿里云试用。把会议、邮箱、CRM 收敛成必须推进项与复核入口。不自动发送 / 不自动审批 / 不承诺 SLA。`git clone && docker compose up`。github.com/Helm-Developers/helm2026

English:

> Releasing Helm v0.1.0-trial today: a controlled-trial advancement console. Apache-2.0 + Aliyun cn-hangzhou trial. Collapses meetings, email, CRM into must-push items + formal-review handoffs. No auto-send. No SLA. `git clone && docker compose up`. github.com/Helm-Developers/helm2026
...
>
> 路线图与试用 runbook：github.com/Helm-Developers/helm2026
...
>
> Roadmap and trial runbook: github.com/Helm-Developers/helm2026
...
> 6. 75–90s：`docker compose up` 终端动画 + 结尾 CTA「github.com/Helm-Developers/helm2026」
>
