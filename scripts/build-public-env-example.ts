...
# Optional deployment entry profile. Omit these values to retain the public
# open-source homepage and unrestricted public workspace behavior.
# Profiles: public | cloud | tenant | first-party.
# \`tenant\` and \`first-party\` fail closed unless at least one workspace slug or
# system key is declared. Private profiles never enable self-serve signup.
HELM_DEPLOYMENT_ENTRY_PROFILE="public"
HELM_DEPLOYMENT_ENTRY_DISPLAY_NAME="Helm"
...
# unless the private release process injects a non-secret opaque ID matching
# 1-128 ASCII characters: [A-Za-z0-9][A-Za-z0-9._:-]*.
HELM_HEALTH_ATTESTATION_MODE="reachability"
...
# QoderWork external-agent MCP stays fail-closed unless both this deployment
