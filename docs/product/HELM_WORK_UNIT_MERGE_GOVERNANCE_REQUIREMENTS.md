...
该切片不代表 HWU-01 到 HWU-15 全量实现完成。UI 决策卡、真实运行时状态机、私有主线账本、
owner 通知 / 升级、tenant / overlay 侧 activation receipt、经验入库自动化和 proof viewer
仍属于后续切片。Public Core 仍只保存 schema、guard、测试和 synthetic fixture。
