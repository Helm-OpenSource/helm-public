...
| Community and contributor operations | Formed as an owner packet; triage labels have owner authorization, while public intake cadence and template dry-run still require PR #56 merge | [Community operations owner packet](operations/HELM_COMMUNITY_OPERATIONS_OWNER_PACKET_2026-06-02.md) |
