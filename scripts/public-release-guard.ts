...
const PUBLIC_PACKAGE_SCRIPT_OVERRIDES: Readonly<Record<string, string>> = {
  ...
  "eval:governed-runtime-contracts":
    "vitest run lib/llm/governed-runtime-contracts.test.ts lib/llm/governed-candidate-materializer.test.ts scripts/check-llm-candidate-boundaries.test.ts --config vitest.public.config.ts",
