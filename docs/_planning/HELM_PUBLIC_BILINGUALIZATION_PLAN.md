...
3. After sampling 264 `.tsx` files, a small set of hard-coded English UI labels
   ...
   boundary notes, draft summaries, risk-guard copy, and contrast-test /
   dark-mode-test low-frequency public test-route explanatory copy, have also
   been localized for Chinese operation fields. This
