...
DATABASE_URL="mysql://root:***@${HELM_DB_HOST}/helm2026_ci_verify?charset=utf8mb4" ./node_modules/.bin/vitest run lib/operating-system/index.test.ts lib/billing/ops-summary.test.ts features/memory/memory-approval-evidence-context.test.ts
git diff --check
```
