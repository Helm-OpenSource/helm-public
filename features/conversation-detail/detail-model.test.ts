...
import { buildConversationDetailPageContract } from "./detail-model";
...
function buildDetail(): ProposalPackageCommercialDetail {
  return {
    ...
    nextAction: "Review next conversation",
    memoryFacts: [],
    memoryEntries: [],
    commitments: [
      {
