...
const zh = {
  ...
  eventLabels: {
    ...
    recommendation_generated: "生成 recommendation",
    recommendation_card_viewed: "看到 recommendation 卡片",
    recommendation_explanation_viewed: "展开 recommendation 依据",
    recommendation_action_created: "按 recommendation 生成动作",
    recommendation_feedback_submitted: "提交 recommendation 反馈",
    recommendation_accepted: "采纳 recommendation",
    recommendation_rejected: "拒绝 recommendation",
