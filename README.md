...
```bash
git clone https://github.com/Helm-Developers/helm2026.git
cd helm2026
...
| [GitHub Discussions](https://github.com/Helm-Developers/helm2026/discussions) | 社区问答、卡点求助、vertical 共建 |
...
| **💬 [GitHub Discussions](https://github.com/Helm-Developers/helm2026/discussions)** | 社区问答、vertical 共建、卡点求助 |
