...
export const HELM_V2_EVENT_CATALOG: Array<{
  ...
  },
  {
    ...
    summary: "审批已完成，可继续低风险仅草稿行动层。",
  },
  {
    type: "handoff.requested",
    producer: "human",
    consumers: ["lead-orchestrator", "handoff-manager"],
    summary: "成交或阶段切换后，请求生成交接资料。",
  },
  {
    type: "handoff.created",
    producer: "handoff-manager",
    consumers: ["lead-orchestrator"],
    summary: "交接资料已生成，可进入交付或客户成功接手面。",
  },
];
...
export const HELM_V2_API_CONTRACTS: HelmV2ApiContract[] = [
  ...
  },
  {
    ...
    method: "POST",
    description: "人工确认会议事实，并触发对象经营记忆晋升。",
  ...
  },
  {
    ...
    method: "POST",
    description: "写入阴影阶段 / 阻塞 / 下一步，并生成主管关注标记。",
  ...
  },
  {
    ...
    method: "POST",
    description: "对草稿制品发起风险与承诺边界检查和审批请求。",
  ...
  },
  {
    ...
    method: "POST",
    description: "在成交或交接请求后生成交接资料和交付检查清单。",
