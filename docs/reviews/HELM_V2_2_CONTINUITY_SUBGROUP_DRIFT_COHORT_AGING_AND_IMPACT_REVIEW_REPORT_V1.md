...
---
# Helm v2.2 Continuity Subgroup Drift Cohort Aging And Impact Review Report v1
...
PR37 继续只在 continuity surface 与 operator workflow 内推进：
...
- `features/internal-operating-workspace/runtime-operator-panel.tsx`
  - `continuity-pilot-cases-card` 现在显示：
    - subgroup cohort aging review summary / aggregate / findings
  - `continuity-threshold-revision-card` 现在显示：
    - cross-surface interval wording regression summary / aggregate / findings / adjustment recommendations
  - `continuity-drift-card` 现在显示：
    - material impact sampling review summary / aggregate / findings / optimization hints

### 2.3 Eval / tests / e2e

- `lib/helm-v2/runtime-upgrade.test.ts`
  - 补充 PR37 cohort aging / wording regression / impact sampling 断言
- `lib/helm-v2/eval-harness.ts`
  - 新增 `runHelmV22ContinuitySubgroupDriftCohortAgingImpactReviewEvalHarness()`
- `lib/helm-v2/eval-harness.test.ts`
  - 新增 PR37 harness coverage
- 新增：
  - `evals/helm-v2/continuity-subgroup-drift-cohort-aging-impact-review-v2_2-golden-samples.json`
  - `scripts/helm-v2-2-continuity-subgroup-drift-cohort-aging-impact-review-evals.ts`
- `tests/e2e/continuity-remediation-analytics.spec.ts`
  - 新增 cohort aging / wording regression / impact sampling operator insight 断言

### 2.4 Docs / guard

- 新增：
  - `docs/product/HELM_V2_2_CONTINUITY_SUBGROUP_DRIFT_COHORT_AGING_AND_IMPACT_REVIEW_BASELINE_V1.md`
  - `docs/reviews/HELM_V2_2_CONTINUITY_SUBGROUP_DRIFT_COHORT_AGING_AND_IMPACT_REVIEW_REPORT_V1.md`
- 更新：
  - `README.md`
  - `docs/README.md`
...
- `npm run eval:helm-v2-2-phase17`
- `npm run lint`
- `npm run self-check`
...
PR37 已把 continuity pilot review 从“subgroup stability drift review / interval wording aging audit / material impact pattern aging review”推进到“subgroup drift cohort aging review / cross-surface interval wording regression review / material impact sampling review”。  
