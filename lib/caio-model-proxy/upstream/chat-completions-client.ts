...
// Terminal SSE marker for the Chat Completions streaming protocol.
const CHAT_COMPLETIONS_TERMINAL_DATA = "[DONE]";
...
function containsChatCompletionsTerminal(text: string): boolean {
  return text.includes(`data: ${CHAT_COMPLETIONS_TERMINAL_DATA}`);
}
